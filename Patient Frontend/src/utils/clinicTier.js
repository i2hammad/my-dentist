...
export function getClinicTier(facilityScore = 0) {
  const s = facilityScore || 0;
  if (s >= 31) return { label: 'Elite Clinic', color: '#F59E0B', tier: 'elite' };
  if (s >= 16) return { label: 'Modern Clinic', color: '#0052FF', tier: 'modern' };
